...
namespace BlogEngine.Tests.BlogEngineBusinessTests
{
    ...
    public class Delete
    {
        ...
        public void WhenIdIsNull()
        {
            ...
            EntityPrimaryKey objectDelete = null;
            
            // Act
            BlogEngineBusiness objectBusiness = new BlogEngineBusiness(objectRepositoryTest);
            EntityResponse<BlogEngine> ResponseService = objectBusiness.Delete(objectDelete);
        ...
        public void WhenTheResponseIsValid()
        {
            ...
            EntityPrimaryKey objectDelete = new EntityPrimaryKey()
            {
                Id = 1
            };
            // Act
